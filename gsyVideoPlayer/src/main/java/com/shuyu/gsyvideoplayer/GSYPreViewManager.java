...
public class GSYPreViewManager implements IMediaPlayer.OnPreparedListener, IMediaPlayer.OnSeekCompleteListener {
    ...
    public static synchronized GSYPreViewManager instance(Context context) {
        if (videoManager == null) {
            videoManager = new GSYPreViewManager(context);
        }
        return videoManager;
    }

    public GSYPreViewManager(Context context) {
        mContext = context;
    ...
    private void initIJKPlayer(Message msg) {
        mediaPlayer =  new ffplay(mContext) ;
