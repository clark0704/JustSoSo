...
import com.huwenmin.playerexample.video.WasuBaseVideoPlayer;
...
public class SmallVideoTouch implements View.OnTouchListener {
    ...
    private WasuBaseVideoPlayer mGsyBaseVideoPlayer;


    public SmallVideoTouch(WasuBaseVideoPlayer gsyBaseVideoPlayer, int marginLeft, int marginTop) {
        super();
